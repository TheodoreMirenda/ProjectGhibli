...
namespace TJ
{
    ...
    public partial struct ZombieWalkSystem : ISystem
    {
        ...
        public void OnUpdate(ref SystemState state)
        {
            ...
            var brainEntity = SystemAPI.GetSingletonEntity<CastleTag>(); //empty entity that is used to get the brain position
    ...
    public partial struct ZombieWalkJob : IJobEntity
    {
        ...
        private void Execute(ZombieWalkAspect zombie, [ChunkIndexInQuery] int sortKey)
        {
            ...
            if (zombie.IsInStoppingRange(float3.zero, BrainRadiusSq))//if the zombie is in stopping range, chill with the walk and eat
            {
