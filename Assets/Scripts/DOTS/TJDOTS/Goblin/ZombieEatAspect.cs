...
namespace TJ
{
    public readonly partial struct ZombieEatAspect : IAspect
    {
        ...
        public void Eat(float deltaTime, EntityCommandBuffer.ParallelWriter ecb, int sortKey, Entity brainEntity)
        {
            ...
            _transform.ValueRW.Rotation = quaternion.Euler(eatAngle, Heading, 0);//rocks back and forth on the x axis
        ...
        {
            return math.distancesq(brainPosition, _transform.ValueRW.Position) <= brainRadiusSq - 1;
        }
    }
}